    ...
    for epoch in range(opts.num_epochs):
        ...
        for batch in train_dataloader:
            ...
            if iteration % opts.log_step == 0:
                print('Iteration [{:4d}/{:4d}] | D_real_loss: {:6.4f} | D_fake_loss: {:6.4f} | G_loss: {:6.4f} | G_steps: {:4d}'.format(
                       iteration, total_train_iters, D_real_loss.data[0], D_fake_loss.data[0], G_loss.data[0], G_steps))
...
def create_parser():
    ...
    parser.add_argument('--gen_loss_threshold', type=float, default=0.25)
